...
def toGumtreeNode(parsoNode):
  ...
  #print(parsoNode,startPos,length)
  if startPos==11745 and length==27:
      print(parsoNode.get_code())
      sys.exit()
  return gumtreeNode
...
if __name__ == '__main__':
  main('/root/empirical/extract/commit_files/airflow/116a8a0c67aff3a06e7d66867464555546103b0e/airflow#utils#dag_processing.py')