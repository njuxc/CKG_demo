...
if __name__=='__main__':
  ...
  annot_dict=json.loads(annot_doc)
  print(type(annot_dict))
  print(annot_dict)
  with open('jsons/tmp.json','w+') as f:
      json.dump(annot_dict, f)
  #根据ner找textAPI，根据code change找codeAPI
